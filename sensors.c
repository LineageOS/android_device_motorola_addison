...
static const struct sensor_t sSensorList[] = {
    ...
    { "BMP180 Pressure sensor",
                ...
                SENSOR_TYPE_PRESSURE, 125000.0f, 1.0f, 0.0f, 20000, 0, 0, { } },
    ...
    { "BMP180 Temperature sensor",
                ...
                SENSOR_TYPE_TEMPERATURE, 115.0f, 1.6f, 3.0f, 0, 0, 0, { } },
    { "CT406 Light sensor",
                "TAOS",
    ...
    { "Linear Acceleration",
                ...
                SENSOR_TYPE_LINEAR_ACCELERATION, 0.0f, 0.0f, 0.0f, 0, 0, 0, { } },
    { "Gravity",
                "Motorola",
                1, SENSORS_HANDLE_BASE+ID_GR,
                SENSOR_TYPE_GRAVITY, 0.0f, 0.0f, 0.0f, 0, 0, 0, { } },
